...
module.exports = React.createClass({
	...
	render() {
		...
		var datePickerBackground = this.props.isOpen ? <div className="modal-backdrop date-picker-backdrop" onClick={this.props.backdropClosesDateSelect ? this.props.onChange : null} /> : null;
